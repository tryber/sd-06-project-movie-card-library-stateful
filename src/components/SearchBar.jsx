    ...
    return (
      <div>
        <form data-testid="search-bar-form">
          ...
          <input
            type="text" id="text-input" data-testid="text-input" value={searchText} onChange={onSearchTextChange}
          />

          <input
            type="checkbox" id="bookmark-checked" data-testid="checkbox-input" checked={bookmarkedOnly} onChange={onBookmarkedChange}
          />
