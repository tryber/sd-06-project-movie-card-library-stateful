    ...
    return (
      <form data-testid="add-movie-form"> 
        ...
        <label data-testid="image-input-label">Imagem
          ...
          value={this.state.imagePath} onChange={this.handleChange}></input>
        </label>
        ...
        <label data-testid="rating-input-label">Avaliação
          <input name="rating" data-testid="rating-input" type="number" value={this.state.rating} onChange={this.handleChange} />
        </label>
