...
class MovieLibrary extends Component {
  ...
  filterMovies(value, isItCheckBox) {
    ...
    const filteredMovies = originalList.filter(movie => {
      ...
      return isInMovieTitle || isInMovieSubtitle || isInMovieStoryline || isItBookMarked || checkGenre;
    })
  ...
  handleTextChange({ target }) {
    ...
    this.setState({ [name]: value }, () => {
      this.filterMovies(value, isItCheckBox);
    });
  }
  ...
  render() {
    ...
    return <div>
      <SearchBar searchText={searchText} bookmarkedOnly={bookmarkedOnly} 
        selectedGenre={selectedGenre} onSearchTextChange={this.handleTextChange}
        onBookmarkedChange={this.handleTextChange} onSelectedGenreChange={this.handleTextChange}/>;
