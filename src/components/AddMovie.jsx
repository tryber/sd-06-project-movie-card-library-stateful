    ...
    return (
      <div>
        <form onSubmit={this.addMovie}>
          ...
          <input value={this.props.title} type="text" name="title"
            data-testid="title-input" onChange={this.handleChange}/>
          <label data-testid="subtitle-input-label">Subtítulo</label>
          <input name="subtitle" value={this.state.subtitle} type="text"
            onChange={this.handleChange} data-testid="subtitle-input" />
          ...
          <input name="rating" data-testid="rating-input" value={this.state.rating}
            type="number" onChange={this.handleChange} />
          <label data-testid="genre-input-label">Gênero</label>
          <select data-testid="select-input" value={this.state.genre}
            onChange={this.genreChanger} >
