  ...
  render() {
    ...
    return (
      <form data-testid="add-movie-form">
        ...
        <input data-testid="title-input" name="title" onChange={this.handleChange} value={title} />
        <label data-testid="subtitle-input-label" htmlFor="subtitle-input">Subtítulo</label>
        <input data-testid="subtitle-input" name="subtitle" onChange={this.handleChange} value={subtitle} />
        <label data-testid="image-input-label" htmlFor="image-input">Imagem</label>
        <input data-testid="image-input" name="imagePath" onChange={this.handleChange} value={imagePath} />
        ...
        <input data-testid="rating-input" name="rating" type="number" onChange={this.handleChange} value={rating} />
