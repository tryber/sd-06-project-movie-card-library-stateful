...
class AddMovie extends Component {
  ...
  render() {
    const titleInput = {
      onChange: 'AddMovie.setState(title)',
    }
    const subTitleInput = {
      onChange: 'AddMovie.setState(subtitle)',
    }
    const imageInput = {
      onChange: 'AddMovie.setState(imagePath)',
    }
    const storylineInput = {
      onChange: 'AddMovie.setState(storyline)',
    }
    const ratingInput = {
      type: 'number',
