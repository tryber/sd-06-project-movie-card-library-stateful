  ...
  render() {
    return (
      <form data-testid="search-bar-form">
        <fieldset><AddMovieInput
            labelTestid="text-input-label" id="text-input" label="Inclui o texto" inputType="text"
            testid="text-input" callback={this.props.onSearchTextChange} value={this.props.searchText} />
          <label data-testid="checkbox-input-label" htmlFor="fav-checkbox">Mostrar somente favoritos</label>
            <input type="checkbox" checked={this.props.bookmarkedOnly} id="fav-checkbox"
              onChange={this.props.onBookmarkedChange} data-testid="checkbox-input" /></fieldset>
        <fieldset><label data-testid="select-input-label" htmlFor="movie-type">Filtrar por gênero</label>
