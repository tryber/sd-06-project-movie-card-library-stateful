		...
		return(
			<div>
				<form onSubmit={this.addMovie}>
					...
					<input value={this.props.title} type="text"  name="title" onChange={this.handleChange} data-testid="title-input"/>
					...
					<textarea data-testid="storyline-input"  name="storyline" value={this.state.storyline} type="text" onChange={this.handleChange}></textarea>
