  ...
  render() {
    ...
    return (
      <form data-testid="add-movie-form">
        ...
        <input type="text" id="titulo" value={this.state.title} data-testid="title-input" onChange={this.changeTitle} />
        <label htmlFor="subtitulo" data-testid="subtitle-input-label">Subtítulo</label>
        <input type="text" id="subtitulo" value={this.state.subtitle} data-testid="subtitle-input" onChange={this.changeTitle} />
        <label htmlFor="imagem" data-testid="image-input-label">Imagem</label>
        <input type="text" id="imagem" value={this.state.imagePath} data-testid="image-input" onChange={this.changeTitle} />
        <label htmlFor="sinopse" data-testid="storyline-input-label">Sinopse</label>
        <input type="textarea" id="sinopse" value={this.state.storyline} data-testid="storyline-input" onChange={this.changeTitle} />
        <label htmlFor="aval" data-testid="rating-input-label">Avaliação</label>
        <input type="number" id="aval" value={this.state.rating} data-testid="rating-input" onChange={this.changeTitle} />
